...
const PaymentSuccessfull = () => {
  ...
  useEffect(() => {
    // Assuming you've already handled the order placement process
  ...
  return (
    <section className="pt-32 pb-12 lg:py-32 h-screen">
      <div className="container mx-auto mb-10 sm:px-10 lg:px-20 xl:px-3">
        <div className="">
          <div className="flex justify-start item-start space-y-2 flex-col md:ml-5">
            <h1 className="text-3xl ml-5 md:ml-0 lg:ml-0 dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">
