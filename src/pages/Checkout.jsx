      ...
      <div className="lg:flex-row sm:flex-col container mx-auto flex sm:px-10 lg:px-20 xl:px-32">
        ...
        <div className="flex-1 flex flex-col bg-gray-50 px-4 pt-8 lg:mt-0 sm:mt-10">
            ...
            <form className="mt-5 grid gap-6">
              <div className="relative">
                ...
                >
                  ...
                  />
                  <div className="ml-5">
                    <span className="mt-2 font-semibold">Canada post</span>
          ...
          <div className="mt-6 mb-8">
            <Link to="/payment" onClick={dispatch(setIsActive(true))}>
              <button className="w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">
                Place Order
              </button>
            </Link>
          </div>
